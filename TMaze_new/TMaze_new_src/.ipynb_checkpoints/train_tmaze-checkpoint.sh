...
# error 5/10
# python3 TMaze_new/TMaze_new_src/train_RATE_new.py --model_mode 'RATE' --max_n_final 5 --start_seg 6 --end_seed 10
...
python3 TMaze_new/TMaze_new_src/train_RATE_new.py --model_mode 'DT' --max_n_final 5 --start_seg 8 --end_seed 10
