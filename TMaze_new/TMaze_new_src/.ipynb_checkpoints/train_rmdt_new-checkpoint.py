...
# TODO:
# TODO: 1. Добавить аргпарс
# TODO: 2. Запустить по 10 ранов на каждый конфиг
# TODO: 3. Сделать .sh скрипт для запуска
...
for RUN in range(1, 10+1): 
    ...
    if config["curriculum"] == True:
        ...
        model, wandb_step, optimizer, scheduler, raw_model = train(model, optimizer, scheduler, raw_model, max_n_final, wandb_step, ckpt_path, config)
