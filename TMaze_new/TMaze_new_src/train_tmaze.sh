...
#~/Egor_C/REPOSITORIES/RATE$ python3 TMaze_new/TMaze_new_src/inference_tmaze.py --model_mode 'DT' --max_n_final 9 --ckpt_name 'loss_all_inf_on_9_segments_DT_min_1_max_9_RUN_10_2024_01_03_04_45_02' 
#--ckpt_chooser 0 